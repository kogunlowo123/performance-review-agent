"""Performance Review Agent - Main Agent Implementation."""
...
class PerformanceReviewAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.review_writing_enabled = True
        self.feedback_aggregation_enabled = True
        self.calibration_analysis_enabled = True
        self.goal_tracking_enabled = True
        self.pip_generation_enabled = True
        self._tool_dispatch = {
            "draft_review": self.tools.draft_review,
            "aggregate_feedback": self.tools.aggregate_feedback,
            "analyze_calibration": self.tools.analyze_calibration,
            "track_goals": self.tools.track_goals,
            "generate_pip": self.tools.generate_pip,
        }
        logger.info(
            "agent_initialized",
    ...
    async def process_message(self, request: ChatRequest, user_id: str) -> ChatResponse:
        ...
        rag_results = await self.rag_pipeline.retrieve(
            ...
            top_k=5,
            filters={"user_id": user_id, "domain": "human_resources"},
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "aggregate_feedback": ['aggregate', 'feedback'],
            "analyze_calibration": ['analyze', 'calibration'],
            "track_goals": ['track', 'goals'],
            "generate_pip": ['generate', 'pip'],
        }
