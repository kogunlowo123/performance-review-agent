"""Performance Review Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Performance Review Agent through a multi-step pipeline.
