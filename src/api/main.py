"""Performance Review Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Performance review agent that assists managers in writing balanced reviews, aggregates peer feedback, identifies rating calibration issues, tracks goal progress, and generates performance improvement plans.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
